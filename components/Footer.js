    ...
    return(
        ...
        text-gray-500">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-4 grid-flow-row-dense">
                ...
                lg:col-start-2 ">
                    <GlobeIcon className="h-5 mr-1 text-green-700"/> since 2022
                </div>
                <div className="flex justify-center space-x-8 whitespace-nowrap md:justify-self-start ml-2">
                    <p>Advertising</p>
                    <p>Business</p>
                    <p>How Search Works</p>
                </div>
                <div className="flex justify-center space-x-8 mr-2 md:ml-auto">
                    <p>Privacy</p>
                    <p>Terms</p>
                    <p>Settings</p>
                </div>
